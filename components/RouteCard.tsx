...
interface RouteCardProps {
  ...
  // Tornamos opcional, pois o Link cuidará da navegação principal
  onPress?: () => void; 
}
...
export default function RouteCard({ rota, onPress }: RouteCardProps) {
  ...
  return (
    <motion.div 
      ...
      whileHover={{ y: -4 }} // Um leve efeito de flutuar ao passar o mouse
      className="bg-white rounded-[40px] overflow-hidden shadow-sm border border-gray-100 mb-6 group relative"
    >
      {/* Envolvemos o conteúdo principal em um Link. 
          O 'id' da rota vai para a URL /roteiro/[id]
      */}
      <Link href={`/roteiro/${rota.id}`} className="block">
        ...
        <div className="p-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100 flex justify-between items-center">
            ...
            {/* O botão agora é visual, mas o clique no card todo funciona */}
            <div className="p-3 bg-gray-900 text-white rounded-2xl group-hover:bg-orange-600 transition-colors">
