...
export default function ExplorarPage() {
  ...
  // Pegando o status do usuário para controlar o acesso ao menu de criação
    ...
    <main className="flex flex-col min-h-screen bg-white pb-24">
      ...
      <header className="p-6 pb-2">
        <div className="flex justify-between items-start mb-4">
          ...
          <button onClick={handlePlusClick} className="bg-orange-600 text-white text-xs font-bold px-4 py-2 rounded-full flex items-center gap-1 shadow-md shadow-orange-200">
